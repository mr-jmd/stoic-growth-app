...
| Configuración de hábitos (sin tope; archivado en dos pasos) | [habits.md](habits.md) | `features/habits/` |
...
| Tour guiado (recorrido con focos, una vez) | [tour.md](tour.md) | `features/tour/` |
...
```
Primer arranque → elegir hábitos (desde 1, sin tope) → Tour guiado → Dashboard (4 virtudes + cita)
